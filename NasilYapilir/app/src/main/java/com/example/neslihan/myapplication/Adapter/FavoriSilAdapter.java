...
public class FavoriSilAdapter extends BaseAdapter {

    public final static String URL = "http://evdekiisim.somee.com/WebService1.asmx";
    public final static String SOAP_ACTION = "http://evdekiisim.somee.com/FavoriSil";
    public static final String NAMESPACE = "http://evdekiisim.somee.com/";
    private static final String METHOD_NAME = "FavoriSil";
    private Urun u;

    public FavoriSilAdapter(Urun u) {
        this.u=u;
    ...
    public class ConversionAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            BegeniArtirAdapter begeniArtirAdapter = new BegeniArtirAdapter(u,"azalt");
        }
    }
}
